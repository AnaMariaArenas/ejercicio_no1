...
public class OperacionesMatematicasTest {
    ...
    public void testMultiplicacion() throws Exception {
        ...
        Assert.assertEquals(0,op.multiplicacion(2,0));

    }

    @Test(expected = ArithmeticException.class)   //En esta parte se coloca la expecion
    ...
    public void testDivision() throws Exception {
        ...
        // Assert.assertEquals(2,op.division(4,2));  Esta es la exeepcion
